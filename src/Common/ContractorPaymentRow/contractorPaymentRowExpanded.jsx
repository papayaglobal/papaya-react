...
import {StyledExpandedContainer} from "../../Common/ContractorPaymentRow/contractorPaymentRowHelpers";
import {Flex} from "../../papaya-styled-components/flex-components";
import {CreatedDate, CreatedDateTime, StyledAttachmentTitle, StyledSubmittedText} from "./contractorPaymentRowHelpers";
import {DARK1, STATUSCRITICAL, STATUSOK} from "../../Constants";
import {formatDateRange} from "../../Constants/date-utils";
...
export const ContractorPaymentRowExpandedContainer = (props) => {
    // rgba(248,83,89,0.10)
